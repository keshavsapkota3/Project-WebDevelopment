        ...
        <!-- starting customer service  -->
         ...
         <!-- start follow us  -->
          ...
          <div class="col-12 col-md-6 col-lg-4" id="footer-first-row">
            ...
            <a href="https://www.facebook.com/login/?privacy_mutation_token=eyJ0eXBlIjowLCJjcmVhdGlvbl90aW1lIjoxNzA4NzkzMjg3LCJjYWxsc2l0ZV9pZCI6MzgxMjI5MDc5NTc1OTQ2fQ%3D%3D" id="footer-text" class="col-9">Facebook</a>
            </div>
